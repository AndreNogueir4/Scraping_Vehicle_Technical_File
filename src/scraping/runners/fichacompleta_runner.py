import asyncio
from src.scraping.scrapers.fichacompleta import (
    automakers as fc_automakers,
    models as fc_models,
    versions_years as fc_version,
    technical_sheet as fc_technical
)
from src.db.mongo import insert_vehicle, get_vehicles_by_reference, insert_vehicle_specs, sheet_code_exists
from src.scraping.runners.common import validate_scraper_data
from src.utils.generate_sheet_code import generate_unique_sheet_code
